...
const TIERS: Tier[] = [
  {
    name: "Starter",
    tagline: "Pour les analystes individuels et les étudiants",
    monthly: 0,
    cta: "Commencer gratuitement",
    features: [
      "1 zone surveillée (ville ou région)",
      "1 domaine au choix",
      "Rafraîchissement quotidien des signaux",
  ...
  {
    name: "Pro",
    tagline: "Pour les journalistes, consultants et petites ONG",
    monthly: 49,
    cta: "Passer au Pro",
    featured: true,
    features: [
      "Jusqu'à 10 zones · tous les domaines",
      "Signaux en temps réel + alertes prédictives",
      "Historique 12 mois & exports CSV / PDF",
      "Ask SentrIA illimité",
      "Alertes e-mail + Slack · 3 dashboards",
    ],
  },
  {
    name: "Team",
    tagline: "Pour les agences, laboratoires et organisations",
    monthly: 199,
    priceLabel: "jusqu'à 5 sièges",
    cta: "Choisir Team",
    features: [
      "Zones & domaines illimités",
      "Espaces partagés + rôles et permissions",
      "Accès API & webhooks",
  ...
  {
    name: "Enterprise",
    tagline: "Pour les gouvernements et grandes institutions",
    monthly: null,
    priceLabel: "Sur devis",
    cta: "Contacter les ventes",
    features: [
      "SSO / SAML, journaux d'audit, résidence des données",
    ...
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <h2 className="max-w-2xl text-balance font-heading text-3xl font-bold tracking-tight sm:text-4xl">
          Une intelligence territoriale pour chaque échelle
        </h2>
        <p className="max-w-xl text-pretty text-muted-foreground">
          Des analystes indépendants aux institutions, choisissez le plan adapté à votre
          couverture, partout dans le monde.
        </p>
          ...
          >
            ...
            <span
              className={cn(
                ...
                annual ? "bg-accent text-accent-foreground" : "bg-accent/30 text-accent-foreground",
              )}
            >
              −20%
            </span>
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        {TIERS.map((t) => (
          ...
          >
            ...
            <div className="mt-5 flex items-end gap-1.5">
              ...
              {t.monthly !== null && t.monthly > 0 && (
                <span
                  className={cn(
                    "pb-1 text-sm",
                    t.featured ? "text-primary-foreground/60" : "text-muted-foreground",
                  )}
                >
                  /mois
                </span>
            ...
            <button
              className={cn(
                "mt-5 w-full rounded-xl py-2.5 text-sm font-semibold transition-opacity hover:opacity-90",
                t.featured
                ...
                <li key={f} className="flex items-start gap-2.5 text-sm">
                  <span
                    className={cn(
                      ...
                      t.featured ? "bg-accent text-accent-foreground" : "bg-accent/25 text-accent-foreground",
                    )}
                  >
                    <Check className="h-3 w-3" />
                  </span>
                  <span className={t.featured ? "text-primary-foreground/90" : "text-foreground/80"}>
                    {f}
                  </span>
                </li>
              ))}
